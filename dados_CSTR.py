# -*- coding: utf-8 -*-
"""
Created on Sat Oct 16 08:54:38 2021
...
num_samples = 3000 # número de amostras 
...
Ts = 0.15
b_range = [1*Ts,200*Ts] # Obs: x*Ts>0.5

q = SinalSequencia(num_samples, q_range, b_range, type='RGS', random_state=27051992)
qc = SinalSequencia(num_samples, qc_range, b_range, type='RGS', random_state=10111993)
...
dados.to_excel('dados_CSTR.xls', index=False)
